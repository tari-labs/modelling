...
for j in range(0, len(no_of_nodes)):
    P_tot.append(hdp.probability(bft_threshold, no_of_bad_actors, committee_size, no_of_nodes))
...
ax1.plot(x, y2, 'b-', label='No of bad actors')
ax1.plot(x, y3, 'r-', label='Committee size')
ax1.plot(x, y4, 'y-', label='BFT threshold')
